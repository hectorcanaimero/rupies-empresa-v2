                                                      ...
                                                      children: [
                                                        ...
                                                        Container(
                                                          ...
                                                          child: InkWell(
                                                            ...
                                                            onTap: () async {
                                                              logFirebaseEvent(
                                                                  'SERVICE_URGENT_Row_bofl7pkn_ON_TAP');
                                                              // Data Entrada
                                                              logFirebaseEvent(
                                                                  'Row_DataEntrada');
                                                      ...
                                                      children: [
                                                        ...
                                                        Container(
                                                          ...
                                                          child: InkWell(
                                                            ...
                                                            onTap: () async {
                                                              logFirebaseEvent(
                                                                  'SERVICE_URGENT_Row_y4ulqpry_ON_TAP');
                                                              // Data Entrada
                                                              logFirebaseEvent(
                                                                  'Row_DataEntrada');
                                      ...
                                      FFButtonWidget(
                                        onPressed: () async {
                                          ...
                                          logFirebaseEvent(
                                              'button_backend_call');
                                          _model.notif =
                                              await NotificationsNewServiceTable()
                                                  .insert({
                                            'categories_id':
                                                stackServicesRow?.categoryId,
                                            'service_id': stackServicesRow?.id,
                                            'title':
                                                'Novo serviço disponível para você',
                                            'body':
                                                'Temos uma novidade para você.                   Um novo serviço relacionado a sua categoria já está disponível no app.                   Confira agora e aproveite esta nova oportunidade.',
                                          });
                                          logFirebaseEvent(
                                              'button_alert_dialog');
                                          await showDialog(
