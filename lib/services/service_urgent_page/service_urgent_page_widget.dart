                                            ...
                                            child: Row(
                                              ...
                                              children: [
                                                ...
                                                InkWell(
                                                  ...
                                                  onTap: () async {
                                                    logFirebaseEvent(
                                                        'SERVICE_URGENT_Icon_hwx228cb_ON_TAP');
                                                    logFirebaseEvent(
                                                    ...
                                                    if (selectedMedia != null &&
                                                        selectedMedia.every((m) =>
                                                            validateFileFormat(
                                                                ...
                                                                context))) {
                                                      safeSetState(() => _model
                                                              .isDataUploading_uploadAgendado =
                                                          true);
                                                      ...
                                                      try {
                                                        ...
                                                        _model.isDataUploading_uploadAgendado =
                                                            false;
                                                      }
                                                      if (selectedUploadedFiles
                                                          ...
                                                          downloadUrls.length ==
                                                              selectedMedia
                                                                  .length) {
                                                        safeSetState(() {
                                                          _model.uploadedLocalFile_uploadAgendado =
                                                              selectedUploadedFiles
                                                                  .first;
                                                          _model.uploadedFileUrl_uploadAgendado =
                                                              downloadUrls
                                                                  .first;
                                                        });
                                                      } else {
                                                    ...
                                                    _model.createImage =
                                                      ...
                                                      'serviceId': FFAppState()
                                                          .serviceId,
                                                      'image': _model
                                                          .uploadedFileUrl_uploadAgendado,
                                                    });
                                                    logFirebaseEvent(
                                                        ...
                                                        child: Stack(
                                                          ...
                                                          children: [
                                                            InkWell(
                                                              ...
                                                              onTap: () async {
                                                                logFirebaseEvent(
                                                                    'SERVICE_URGENT_PAGE_PAGE_Image1_ON_TAP');
                                                                logFirebaseEvent(
                                                                    'Image1_expand_image');
                                                                await Navigator
                                                                    .push(
                                                                      ...
                                                                      image:
                                                                        ...
                                                                        placeholderBuilder:
                                                                          ...
                                                                          child:
                                                                              Image(
                                                                            image:
                                                                                BlurHashImage(_model.uploadedLocalFile_uploadAgendado.blurHash!),
                                                                            fit:
                                                                                BoxFit.cover,
                                                                          ),
                                                                        ),
                                                                    ...
                                                                    placeholderBuilder: (_) =>
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        image: BlurHashImage(_model
                                                                            .uploadedLocalFile_uploadAgendado
                                                                            .blurHash!),
                                                                        fit: BoxFit
                                                                            .cover,
                                                                      ),
                                                              ...
                                                              child: Padding(
                                                                ...
                                                                child: InkWell(
                                                                  ...
                                                                  onTap:
                                                                      () async {
                                                                    logFirebaseEvent(
                                                                        'SERVICE_URGENT_Icon_tq7br1my_ON_TAP');
                                                                    logFirebaseEvent(
                                                                        'Icon_backend_call');
                                                                    await ServicesImagesTable()
                                                                        .delete(
                                            ...
                                            child: Padding(
                                              padding: EdgeInsetsDirectional
                                                  .fromSTEB(
                                                      0.0, 0.0, 0.0, 21.0),
                                              child: Text(
                                                'Equipamentos, Documentos ou Habilidades ',
                                                style:
                                                    FlutterFlowTheme.of(context)
                                                        .headlineSmall
                                                        .override(
                                                            ...
                                                            children: [
                                                              ...
                                                              InkWell(
                                                                ...
                                                                onTap:
                                                                    () async {
                                                                  logFirebaseEvent(
                                                                      'SERVICE_URGENT_Icon_1kjmqmpm_ON_TAP');
                                                                  logFirebaseEvent(
                                                                      'Icon_backend_call');
                                                                  await ServicesSkillsTable()
                                                                      .delete(
