                    ...
                    child: Padding(
                      ...
                      child: FutureBuilder<List<ChatsMessageRow>>(
                        ...
                        builder: (context, snapshot) {
                          ...
                          List<ChatsMessageRow> listViewChatsMessageRowList =
                              snapshot.data!;
                          ...
                          return ListView.separated(
                            ...
                            itemCount: listViewChatsMessageRowList.length,
                            separatorBuilder: (_, __) => SizedBox(height: 15.0),
                            itemBuilder: (context, listViewIndex) {
                              final listViewChatsMessageRow =
                                  listViewChatsMessageRowList[listViewIndex];
                              return Align(
                                alignment: AlignmentDirectional(
                                    valueOrDefault<double>(
                                      listViewChatsMessageRow.typeMessage ==
                                        ...
                                        Align(
                                          ...
                                          child: Builder(
                                            builder: (context) {
                                                      ...
                                                      PageTransition(
                                                        ...
                                                        child:
                                                          ...
                                                          image: OctoImage(
                                                            ...
                                                            image: NetworkImage(
                                                              functions.parseTextToImage(
                                                                  listViewChatsMessageRow
                                                                      .content!),
                                                            ),
                                                            fit: BoxFit.contain,
                                                          ),
                                              ...
                                              } else if (listViewChatsMessageRow
                                                      .sendType ==
                          ...
                          child: TextFormField(
                            ...
                            onFieldSubmitted: (_) async {
                              ...
                              _model.createCopy =
                                ...
                                'typeMessage': MessageSendType.Contractor.name,
