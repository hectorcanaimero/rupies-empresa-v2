...
import 'service_schedule_page_model.dart';
export 'service_schedule_page_model.dart';

class ServiceSchedulePageWidget extends StatefulWidget {
  const ServiceSchedulePageWidget({super.key});

  static String routeName = 'ServiceSchedulePage';
  static String routePath = '/serviceSchedulePage';

  @override
  State<ServiceSchedulePageWidget> createState() =>
      _ServiceSchedulePageWidgetState();
}

class _ServiceSchedulePageWidgetState extends State<ServiceSchedulePageWidget> {
  late ServiceSchedulePageModel _model;
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    FFButtonWidget(
                                      onPressed: () async {
                                        logFirebaseEvent(
                                            'SERVICE_SCHEDULE_VOLTAR_BTN_ON_TAP');
                                        logFirebaseEvent(
                                    ...
                                    FFButtonWidget(
                                      onPressed: () async {
                                        logFirebaseEvent(
                                            'SERVICE_SCHEDULE_SEGUINTE_BTN_ON_TAP');
                                          ...
                                          await showDialog(
                                            ...
                                            builder: (alertDialogContext) {
                                              return AlertDialog(
                                                title: Text('Opa!'),
                                                content: Text(
                                                    'Verifiqeu os campos de datas. Campos Obrigatorio'),
                                                actions: [
                                                  TextButton(
                                                    onPressed: () =>
                                                        Navigator.pop(
                                            ...
                                            child: Row(
                                              ...
                                              children: [
                                                ...
                                                InkWell(
                                                  ...
                                                  onTap: () async {
                                                    logFirebaseEvent(
                                                        'SERVICE_SCHEDULE_Icon_2brr7zx7_ON_TAP');
                                                    logFirebaseEvent(
                                                    ...
                                                    if (selectedMedia != null &&
                                                        selectedMedia.every((m) =>
                                                            validateFileFormat(
                                                                ...
                                                                context))) {
                                                      safeSetState(() => _model
                                                              .isDataUploading_uploadUrgenteEditar =
                                                          true);
                                                      ...
                                                      if (selectedUploadedFiles
                                                          ...
                                                          downloadUrls.length ==
                                                              selectedMedia
                                                                  .length) {
                                                        safeSetState(() {
                                                          _model.uploadedLocalFile_uploadUrgenteEditar =
                                                              selectedUploadedFiles
                                                                  .first;
                                                        ...
                                                        child: Stack(
                                                          ...
                                                          children: [
                                                            InkWell(
                                                              ...
                                                              onTap: () async {
                                                                logFirebaseEvent(
                                                                    'SERVICE_SCHEDULE_PAGE_PAGE_Image1_ON_TAP');
                                                                logFirebaseEvent(
                                                                    'Image1_expand_image');
                                                                await Navigator
                                                                    .push(
                                                                      ...
                                                                      image:
                                                                        ...
                                                                        placeholderBuilder:
                                                                          ...
                                                                          child:
                                                                              Image(
                                                                            image:
                                                                                BlurHashImage(_model.uploadedLocalFile_uploadUrgenteEditar.blurHash!),
                                                                            fit:
                                                                                BoxFit.cover,
                                                                          ),
                                                                        ),
                                                                    ...
                                                                    placeholderBuilder: (_) =>
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        image: BlurHashImage(_model
                                                                            .uploadedLocalFile_uploadUrgenteEditar
                                                                            .blurHash!),
                                                                        fit: BoxFit
                                                                            .cover,
                                                                      ),
                                                              ...
                                                              child: Padding(
                                                                ...
                                                                child: InkWell(
                                                                  ...
                                                                  onTap:
                                                                      () async {
                                                                    logFirebaseEvent(
                                                                        'SERVICE_SCHEDULE_Icon_xsb8neyg_ON_TAP');
                                                                    logFirebaseEvent(
                                                                        'Icon_backend_call');
                                                                    await ServicesImagesTable()
                                                                        .delete(
                                                          ...
                                                          child: Row(
                                                            ...
                                                            children: [
                                                              Text(
                                                                valueOrDefault<
                                                                    String>(
                                                                  staggeredSkillViewServicesSkillsRow
                                                                      .name,
                                                                  'Skil',
                                                                ),
                                                                style: FlutterFlowTheme.of(
                                                              ...
                                                              InkWell(
                                                                ...
                                                                onTap:
                                                                    () async {
                                                                  logFirebaseEvent(
                                                                      'SERVICE_SCHEDULE_Icon_2h2629ds_ON_TAP');
                                                                  logFirebaseEvent(
                                                                      'Icon_backend_call');
                                                                  await ServicesSkillsTable()
                                                                      .delete(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    FFButtonWidget(
                                      onPressed: () async {
                                        logFirebaseEvent(
                                            'SERVICE_SCHEDULE_ANTERIOR_BTN_ON_TAP');
                                        logFirebaseEvent('Button_page_view');
                                        await _model.pageViewController
                                            ?.previousPage(
