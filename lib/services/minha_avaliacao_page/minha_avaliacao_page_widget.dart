...
import 'minha_avaliacao_page_model.dart';
export 'minha_avaliacao_page_model.dart';

class MinhaAvaliacaoPageWidget extends StatefulWidget {
  ...
  State<MinhaAvaliacaoPageWidget> createState() =>
      _MinhaAvaliacaoPageWidgetState();
}

class _MinhaAvaliacaoPageWidgetState extends State<MinhaAvaliacaoPageWidget> {
  late MinhaAvaliacaoPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MinhaAvaliacaoPageModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'MinhaAvaliacaoPage'});
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          leading: FlutterFlowIconButton(
            ...
            onPressed: () async {
              logFirebaseEvent('MINHA_AVALIACAO_arrow_back_rounded_ICN_O');
