...
import 'lead_contato_page_model.dart';
export 'lead_contato_page_model.dart';

class LeadContatoPageWidget extends StatefulWidget {
  const LeadContatoPageWidget({
    super.key,
    required this.data,
  });
...
class _LeadContatoPageWidgetState extends State<LeadContatoPageWidget> {
  late LeadContatoPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => LeadContatoPageModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'LeadContatoPage'});
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          leading: FlutterFlowIconButton(
            ...
            onPressed: () async {
              logFirebaseEvent('LEAD_CONTATO_arrow_back_rounded_ICN_ON_T');
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: Container(
                                  width: double.infinity,
                                  child: TextFormField(
                                    controller: _model.nameEventoTextController,
                    ...
                    child: Row(
                      ...
                      children: [
                        FFButtonWidget(
                          onPressed: () async {
                            logFirebaseEvent(
                                'LEAD_CONTATO_ENVIAR_MENSAGEM_BTN_ON_TAP');
                            ...
                            if (_model.validate!) {
                              ...
                              _model.create = await LeadContactTable().insert({
                                'name': _model.nameEventoTextController.text,
                              ...
                              await showDialog(
                                ...
                                builder: (alertDialogContext) {
                                  return AlertDialog(
                                    title: Text('Show!'),
                                    content: Text(
                                        'Sua mensagem foi enviada para o solicitante. Aguarde contato.'),
                                    actions: [
                                      TextButton(
                                        onPressed: () =>
