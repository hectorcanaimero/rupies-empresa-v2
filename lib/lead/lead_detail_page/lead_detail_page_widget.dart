...
class _LeadDetailPageWidgetState extends State<LeadDetailPageWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'LeadDetailPage'});
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<LeadsRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<LeadsRow> leadDetailPageLeadsRowList = snapshot.data!;

        final leadDetailPageLeadsRow = leadDetailPageLeadsRowList.isNotEmpty
            ? leadDetailPageLeadsRowList.first
            : null;
          ...
          child: Scaffold(
            ...
            appBar: AppBar(
              ...
              leading: FlutterFlowIconButton(
                ...
                onPressed: () async {
                  logFirebaseEvent('LEAD_DETAIL_arrow_back_rounded_ICN_ON_TA');
                                              ...
                                              child: CarouselSlider.builder(
                                                ...
                                                itemBuilder:
                                                  ...
                                                  return InkWell(
                                                    ...
                                                    onTap: () async {
                                                      logFirebaseEvent(
                                                          'LEAD_DETAIL_Image_6pzlsrav_ON_TAP');
                                                      logFirebaseEvent(
                                                          'Image_expand_image');
                                                ...
                                                Expanded(
                                                  child: Container(
                                                    ...
                                                    child: InkWell(
                                                      ...
                                                      onTap: () async {
                                                        logFirebaseEvent(
                                                            'LEAD_DETAIL_Row_qup594cb_ON_TAP');
                                                        logFirebaseEvent(
                                                            'Row_copy_to_clipboard');
                                                        await Clipboard.setData(
                                                            ClipboardData(
                                                                text: leadDetailPageLeadsRow
                                                                    .contatoDuvida!));
                                                        logFirebaseEvent(
                                                            'Row_show_snack_bar');
                                        ...
                                        Align(
                                          ...
                                          child: Padding(
                                            ...
                                            child: FFButtonWidget(
                                              onPressed: () async {
                                                logFirebaseEvent(
                                                    'LEAD_DETAIL_ENTRE_EM_CONTATO_BTN_ON_TAP');
                                                logFirebaseEvent(
                                                    'Button_navigate_to');

                                                context.pushNamed(
                                                  LeadContatoPageWidget
                                                      .routeName,
                                                  queryParameters: {
                                                    'data': serializeParam(
                                                      leadDetailPageLeadsRow,
