...
class _SubscriptionCheckoutPageWidgetState
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'SubscriptionCheckoutPage'});
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          leading: FlutterFlowIconButton(
            ...
            onPressed: () async {
              logFirebaseEvent('SUBSCRIPTION_CHECKOUT_arrow_back_rounded');
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  FFButtonWidget(
                                    onPressed: () async {
                                      logFirebaseEvent(
                                          'SUBSCRIPTION_CHECKOUT_COPIAR_BTN_ON_TAP');
                                      logFirebaseEvent(
