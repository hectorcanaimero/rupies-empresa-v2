...
import '/widgets/forgot_pwd_widget/forgot_pwd_widget_widget.dart';
import '/index.dart';
...
class _SignPageWidgetState extends State<SignPageWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'SignPage'});
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      ...
                      children: [
                        ...
                        FFButtonWidget(
                          onPressed: () async {
                            logFirebaseEvent('SIGN_PAGE_PAGE_Button2_ON_TAP');
                            logFirebaseEvent('Button2_bottom_sheet');
                        ...
                        Padding(
                          ...
                          child: Container(
                            ...
                            child: InkWell(
                              ...
                              onTap: () async {
                                logFirebaseEvent(
                                    'SIGN_PAGE_PAGE_Row_91zi22hm_ON_TAP');
