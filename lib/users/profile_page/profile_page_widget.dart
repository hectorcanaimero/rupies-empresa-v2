...
class _ProfilePageWidgetState extends State<ProfilePageWidget> {
  ...
  void initState() {
    ...
    _model.cpfCnpjMask = MaskTextInputFormatter(mask: '##.###.###/####-##');
          ...
          child: PopScope(
            ...
            child: Scaffold(
              ...
              appBar: AppBar(
                ...
                leading: Visibility(
                  visible: profilePageUsersRow?.endRegister ?? true,
                ...
                title: Text(
                  valueOrDefault<String>(
                    profilePageUsersRow!.endRegister!
                        ? 'Atualizar Perfil'
                        : 'Criar meu Perfil',
                    'Criar meu Perfil',
                  ),
                                              ...
                                              children: [
                                                ...
                                                Align(
                                                  ...
                                                  child: FlutterFlowIconButton(
                                                    ...
                                                    onPressed: () async {
                                                      logFirebaseEvent(
                                                          'PROFILE_PAGE_PAGE_camera_alt_ICN_ON_TAP');
                                                      logFirebaseEvent(
                                                      ...
                                                      if (selectedMedia !=
                                                          ...
                                                          selectedMedia.every((m) =>
                                                              validateFileFormat(
                                                                  ...
                                                                  context))) {
                                                        safeSetState(() => _model
                                                                .isDataUploading_uploadDataCrestePerfil =
                                                            true);
                                                        ...
                                                        try {
                                                          ...
                                                          ScaffoldMessenger.of(
                                                                  context)
                                                              .hideCurrentSnackBar();
                                                          _model.isDataUploading_uploadDataCrestePerfil =
                                                              false;
                                                        }
                                                        if (selectedUploadedFiles
                                                            ...
                                                            downloadUrls
                                                                ...
                                                                selectedMedia
                                                                    .length) {
                                                          safeSetState(() {
                                                            _model.uploadedLocalFile_uploadDataCrestePerfil =
                                                                selectedUploadedFiles
                                                                    .first;
                                                            _model.uploadedFileUrl_uploadDataCrestePerfil =
                                                                downloadUrls
                                                                    .first;
                                                          });
                                                          showUploadMessage(
                              ...
                              child: Row(
                                ...
                                children: [
                                  FFButtonWidget(
                                    onPressed: () async {
                                      logFirebaseEvent(
                                          'PROFILE_CADASTRAR_R_R_S_S_BTN_ON_TAP');
                                      if (profilePageUsersRow.photoUrl !=
                                              null &&
                                          profilePageUsersRow.photoUrl != '') {
                                        logFirebaseEvent(
                                        ...
                                        await showDialog(
                                          ...
                                          builder: (alertDialogContext) {
                                            return AlertDialog(
                                              title: Text('Opa!'),
                                              content: Text(
                                                  'Para nós é importante sua imagen de perfil.'),
                                              actions: [
                                                TextButton(
                                                  onPressed: () =>
                                                      Navigator.pop(
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  ...
                                                  FFButtonWidget(
                                                    onPressed: () async {
                                                      logFirebaseEvent(
                                                          'PROFILE_PAGE_PAGE_SALVAR_BTN_ON_TAP');
                                                      logFirebaseEvent(
                                                          'Button_backend_call');
                                                      await UsersRrssTable()
                                                          .insert({
                                                        'type': _model
                                                            .dropDownValue,
                                                        'url': _model
                                        ...
                                        Padding(
                                          padding:
                                              EdgeInsetsDirectional.fromSTEB(
                                                  0.0, 12.0, 0.0, 0.0),
                                          child:
                                              FutureBuilder<List<UsersRrssRow>>(
                                            future: (_model
                                                        .requestCompleter1 ??=
                                                    Completer<
                                                        List<UsersRrssRow>>()
                                                        ...
                                                        Align(
                                                          ...
                                                          child:
                                                            ...
                                                            onPressed:
                                                                () async {
                                                              logFirebaseEvent(
                                                                  'PROFILE_PAGE_PAGE_trash_ICN_ON_TAP');
                                                              logFirebaseEvent(
                                                                  'IconButton_backend_call');
                                                              await UsersRrssTable()
                                                                  .delete(
                              ...
                              child: Row(
                                ...
                                children: [
                                  FFButtonWidget(
                                    onPressed: () async {
                                      logFirebaseEvent(
                                          'PROFILE_PAGE_PAGE_VOLTAR_BTN_ON_TAP');
                                      logFirebaseEvent('Button_page_view');
                                      await _model.pageViewController
                                          ?.previousPage(
                                  ...
                                  FFButtonWidget(
                                    onPressed: () async {
                                      logFirebaseEvent(
                                          'PROFILE_ATIVAR_MEU_PERFIL_BTN_ON_TAP');
                                      logFirebaseEvent('Button_backend_call');
                                      _model.update = await UsersTable().update(
                                        data: {
                                          'endRegister': true,
                                        },
                                      ...
                                      FFAppState().user = UserStruct(
                                        displayName: _model
                                            .update?.firstOrNull?.displayName,
                                        phone:
                                            _model.update?.firstOrNull?.phone,
                                        isContractor: _model
                                            .update?.firstOrNull?.isContractor,
                                        addres:
                                            _model.update?.firstOrNull?.address,
                                        cep: _model.update?.firstOrNull?.cep,
                                        cpfcnpj:
                                            _model.update?.firstOrNull?.cpfcnpj,
                                        push: _model.update?.firstOrNull?.push,
                                        photoUrl: _model
                                            .update?.firstOrNull?.photoUrl,
                                        endRegister: _model
                                            .update?.firstOrNull?.endRegister,
                                        rating:
                                            _model.update?.firstOrNull?.rating,
