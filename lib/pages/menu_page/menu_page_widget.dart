                                ...
                                children: [
                                  ...
                                  FutureBuilder<List<SettingsRow>>(
                                    ...
                                    builder: (context, snapshot) {
                                      ...
                                      List<SettingsRow>
                                          containerSettingsRowList =
                                          snapshot.data!;

                                      final containerSettingsRow =
                                          containerSettingsRowList.isNotEmpty
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        InkWell(
                                          ...
                                          onTap: () async {
                                            logFirebaseEvent(
                                                'MENU_PAGE_PAGE_Row_nkra97ug_ON_TAP');
                                            Function() _navigate = () {};
                                            logFirebaseEvent(
                                                'Row_alert_dialog');
