...
import 'not_access_widget_model.dart';
export 'not_access_widget_model.dart';

class NotAccessWidgetWidget extends StatefulWidget {
  const NotAccessWidgetWidget({super.key});

  @override
  State<NotAccessWidgetWidget> createState() => _NotAccessWidgetWidgetState();
}

class _NotAccessWidgetWidgetState extends State<NotAccessWidgetWidget>
    with TickerProviderStateMixin {
  late NotAccessWidgetModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NotAccessWidgetModel());
